...
export function AdminShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="admin-root flex min-h-screen">
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 border-r border-[var(--admin-cream)]/15 bg-[var(--admin-surface)] p-4 transition-transform lg:static lg:translate-x-0 ${open ? 'translate-x-0' : '-translate-x-full'}`}
      >
        ...
        <div className="mt-8 border-t border-[var(--admin-cream)]/15 pt-4">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-20 flex items-center gap-3 border-b border-[var(--admin-cream)]/10 bg-[var(--admin-dark)] px-4 py-3 lg:px-8">
